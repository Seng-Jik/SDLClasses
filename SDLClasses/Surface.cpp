...
void SDL::Surface::Fill(const std::vector<Rect>& rectSet, ColorU8 col)
{
	...
	SDL_FillRects(static_cast<SDL_Surface*>(surfaceHandle_), rects, rectSet.size(), color);
}
...
{
	auto sur = reinterpret_cast<SDL_Surface*>(surfaceHandle_);
